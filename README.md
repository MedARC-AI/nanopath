...
# Short training followed by the COMPLETE probe suite (allow about 25 minutes).
python train.py configs/smoke.yaml

# Train and evaluate the current recipe; interactive full runs offer Labless sign-in.
