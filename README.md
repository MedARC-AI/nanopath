...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 1 | [dino-fino](https://labless.dev/runs/run_sub_1879d32919) | 0.6485 | 0.7863 | 0.7251 | 0.6435 | 0.2924 | 0.6590 | 0.6268 | 0.5661 | 0.8886 | @ml-and-ml |
...
`dino-fino` is a seed-2026 validated retrain of Hassan/ml-and-ml's unvalidated [`jf-hed07`](https://labless.dev/runs/run_sub_3cd4be1e0c) recipe. It is validated but not the Labless leader because its +0.0041 improvement over the current leader is below the 0.006 promotion threshold.
