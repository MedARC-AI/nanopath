...
- After any completed full run or frozen baseline evaluation worth sharing, run `./labless/submit_to_labless.py output_dir=... contributor=... notes=...`; submissions require `summary.json` and `metrics.jsonl`.
